$(document).ready(function () {
    ...
    function recalculate_itemTotlaRow() {
        ...
        $("#item_total").val(
            parseFloat(item_quantity) * parseFloat(item_price) * 1
        );
    }
    $(document).on("click", "#AddItemToIvoiceDetailsRow", function (e) {
        ...
        var is_normal_orOther_name = $(
            "#is_normal_orOther option:selected"
        ).text();
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                $("#itemsrowtableContainterBody").appendChild(data);
    ...
    $(document).on("click", "#Do_Add_new_active_invoice", function (e) {
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                pill_type: pill_type,
                sales_item_type_main: sales_item_type_main,
    ...
    function recalcualte() {
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                sales_item_type: sales_item_type_mainUpdate,
            },
            success: function (data) {},
            error: function () {
                alert("حدث خطا ما");
