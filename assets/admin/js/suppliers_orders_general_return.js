$(document).ready(function () {
  ...
  function make_search() {
    ...
    jQuery.ajax({
      ...
      dataType: 'html',
      cache: false,
      data: { "_token": token_search, searchbyradio: searchbyradio, supplier_code: supplier_code, store_id: store_id, order_date_form: order_date_form, order_date_to: order_date_to, search_by_text: search_by_text },
      success: function (data) {
