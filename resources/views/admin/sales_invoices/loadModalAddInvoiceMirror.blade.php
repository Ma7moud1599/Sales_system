...
<div class="row">
    ...
    <div class="col-md-2" class="form-group">
        <button style="margin-top:35px" class="btn btn-sm btn-danger" id="AddItemToIvoiceDetailsRow">أضف
            للفاتورة</button>
    </div>
</div>
<div class="clearfix"></div>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input readonly oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="total_cost_items"
                id="total_cost_items" class="form-control" value="">
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <input style="background-color: lightgoldenrodyellow" name="notes" id="notes" class="form-control"
                value="">
        </div>
