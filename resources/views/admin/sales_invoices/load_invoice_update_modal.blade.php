@if ($invoice_data['is_approved'] == 0)
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select @if (!@empty($sales_invoices_details) and count($sales_invoices_details) > 0) disabled @endif name="sales_item_type_mainUpdate"
                    id="sales_item_type_mainUpdate" class="form-control ">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select name="is_has_customer" id="is_has_customer" class="form-control">
                    ...
                    <option @if ($invoice_data['is_has_customer'] == 0) selected @endif value="0"> لايوجد عميل( طياري )
                    </option>
                </select>
            </div>
        </div>
        <div class="col-md-4" id="customer_codeDiv">
            <div class="form-group">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="searchbytextforcustomerInupdate"
                        ...
                        <select name="customer_code" id="customer_code" class="form-control ">
                            ...
                            @if (@isset($customers) && !@empty($customers))
                                @foreach ($customers as $info)
                                    <option @if ($invoice_data['customer_code'] == $info->customer_code and $invoice_data['is_has_customer'] == 1) selected @endif
    ...
    <div class="row">
        ...
        <div class="col-md-2" class="form-group">
            <button style="margin-top:35px" class="btn btn-sm btn-success" id="AddItemToIvoiceDetailsActive">أضف
                الصنف فعليا </button>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button data-id="{{ $info->id }}"
                                    class="btn remove_active_row_item are_you_shue btn-sm btn-danger">حذف</button>
                            </td>
                        </tr>
                    @endforeach
                @endif
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input readonly oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="total_cost_items"
                    id="total_cost_items" class="form-control" value="{{ $invoice_data['total_cost_items'] * 1 }}">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input readonly id="tax_value" class="form-control" name="tax_value"
                    value="{{ $invoice_data['tax_value'] * 1 }}">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input @if ($invoice_data['discount_type'] == '' || $invoice_data['discount_type'] == null) readonly @endif
                    oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="discount_percent"
                    id="discount_percent" class="form-control" value="{{ $invoice_data['discount_percent'] * 1 }}">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input readonly name="discount_value" id="discount_value" class="form-control"
                    value="{{ $invoice_data['discount_value'] * 1 }}">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input readonly name="total_cost" id="total_cost" class="form-control"
                    value="{{ $invoice_data['total_cost'] * 1 }}">
            </div>
        </div>
    </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select id="treasuries_id" name="treasuries_id" class="form-control">
                    @if (!@empty($user_shift))
                        <option selected value="{{ $user_shift['treasuries_id'] }}"> {{ $user_shift['name'] }}
                        </option>
                    @else
      ...
      value="0" @endif>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select class="form-control" name="pill_type" id="pill_type">
                        <option value="1" @if ($invoice_data['pill_type'] == 1) selected @endif value="1"> كاش
                        </option>
                        <option value="2" @if ($invoice_data['pill_type'] == 2) selected @endif value="2"> اجل
                        </option>
                    </select>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input name="what_paid" id="what_paid" class="form-control"
                        @if ($invoice_data['pill_type'] == 1) readonly @endif"
                        value="@if ($invoice_data['pill_type'] == 1) {{ $invoice_data['total_cost'] * 1 }} @else 0 @endif">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input readonly name="what_remain" id="what_remain" class="form-control"
                        value="@if ($invoice_data['pill_type'] == 1) 0 @else {{ $invoice_data['what_remain'] * 1 }} @endif">
                </div>
            </div>
            <div class="col-md-6 ">
                <div class="form-group">
            ...
            <div class="col-md-6 text-left">
                <button class="btn btn-sm btn-primary" id="DoApproveInvoiceFinally" style="margin-top:31px;">اعتماد
                    وترحيل الفاتورة</button>
            </div>
        </div>
        @section('script')
