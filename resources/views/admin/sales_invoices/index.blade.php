    ...
    <div class="card">
        <div class="card-header">
            ...
            <input type="hidden" id="ajax_get_load_modal_addMirror"
                value="{{ route('admin.SalesInvoices.load_modal_addMirror') }}">
            <input type="hidden" id="ajax_get_load_modal_addActiveInvoice"
                value="{{ route('admin.SalesInvoices.load_modal_addActiveInvoice') }}">
            ...
            <input type="hidden" id="ajax_get_item_unit_price"
                value="{{ route('admin.SalesInvoices.get_item_unit_price') }}">
            <input type="hidden" id="ajax_get_Add_new_item_row"
                value="{{ route('admin.SalesInvoices.get_Add_new_item_row') }}">
            ...
            <input type="hidden" id="ajax_get_load_invoice_update_modal"
                value="{{ route('admin.SalesInvoices.load_invoice_update_modal') }}">
            <input type="hidden" id="ajax_get_Add_item_to_invoice"
                value="{{ route('admin.SalesInvoices.Add_item_to_invoice') }}">
            <input type="hidden" id="ajax_get_reload_items_in_invoice"
                value="{{ route('admin.SalesInvoices.reload_items_in_invoice') }}">
            <input type="hidden" id="ajax_get_recalclate_parent_invoice"
                value="{{ route('admin.SalesInvoices.recalclate_parent_invoice') }}">
            <input type="hidden" id="ajax_get_remove_active_row_item"
                value="{{ route('admin.SalesInvoices.remove_active_row_item') }}">
            <input type="hidden" id="ajax_DoApproveInvoiceFinally"
                value="{{ route('admin.SalesInvoices.DoApproveInvoiceFinally') }}">
            ...
            <input type="hidden" id="ajax_load_invoice_details_modal"
                value="{{ route('admin.SalesInvoices.load_invoice_details_modal') }}">
            ...
            <input type="hidden" id="ajax_do_add_new_customer"
                value="{{ route('admin.SalesInvoices.do_add_new_customer') }}">
            <input type="hidden" id="ajax_getlastaddedcustomer"
                value="{{ route('admin.SalesInvoices.get_last_added_customer') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($info->is_approved == 0)
                                                    ...
                                                    <a href="{{ route('admin.SalesInvoices.delete', $info->id) }}"
                                                ...
                                                <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white"
                                                    target="_blank"
                                                    href="{{ route('admin.SalesInvoices.printsaleswina4', [$info->id, 'A4']) }}"
                                                    class="btn btn-warning btn-xs"> WA4</a>
                                                <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white"
                                                    target="_blank"
                                                    href="{{ route('admin.SalesInvoices.printsaleswina4', [$info->id, 'A6']) }}"
