...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <input type="hidden" id="ajax_url_get_account_blance"
                value="{{ route('admin.exchange_transaction.get_account_blance') }}">
                                    ...
                                    @if (@isset($accounts) && !@empty($accounts))
                                        @foreach ($accounts as $info)
                                            <option data-type="{{ $info->account_type }}"
                                                ...
                                                value="{{ $info->account_number }}"> {{ $info->name }}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input readonly name="treasuries_balance" id="treasuries_balance" class="form-control"
                                    value="{{ $checkExistsOpenShift['treasuries_balance_now'] * 1 }}">
        ...
        <div class="row" style="padding: 15px;">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input name="from_date_search" id="from_date_search" class="form-control" type="date"
                        value="">
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input name="to_date_search" id="to_date_search" class="form-control" type="date"
                        value="">
                </div>
            </div>
